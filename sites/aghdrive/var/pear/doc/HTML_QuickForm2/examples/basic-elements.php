...
<?php
if ('c:\wamp\www\ols.astem.local\var\pear\data' != '@' . 'data_dir@') {
    $filename = 'c:\wamp\www\ols.astem.local\var\pear\data/HTML_QuickForm2/quickform.css';
} else {
...
$fsCheck->addElement(
    'radio', 'radioTest', array('value' => 1), 
	array('content' => 'select radio #1', 'label' => 'Test radio:')
);
$fsCheck->addElement(
