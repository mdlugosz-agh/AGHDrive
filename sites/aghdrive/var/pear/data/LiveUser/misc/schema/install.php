...
$dsn = 'mysqli://astem-ols:astem-ols-123@localhost/astem-ols?charset=utf8';
...
class LiveUser_Misc_Schema_Install
{
     ...
     * @access public
     */
    public static function generateSchema($obj, $file, $lengths = array(), $defaults = array())
    {
        if (!is_object($obj)) {
            return false;
        }
     ...
     * @access public
     */
    public static function writeSchema($definition, $file)
    {
     ...
     * @access public
     */
    public static function installSchema($obj, $file, $variables = array(), $create = true,
