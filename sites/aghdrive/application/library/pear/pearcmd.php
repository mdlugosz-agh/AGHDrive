...
if ('c:\wamp\www\ols.astem.local\application\library\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('c:\wamp\www\ols.astem.local\application\library\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
