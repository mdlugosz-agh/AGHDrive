...
class LiveUser
{
        ...
        if (array_key_exists('session_cookie_params', $this->_options) && $this->_options['session_cookie_params']) {
            ...
            if (is_array($this->_options['session_cookie_params'])) {
                $this->_options['session_cookie_params'] =
                    ...
                    //M-DL 2019-12-06 LiveUser::arrayMergeClobber($session_cookie_params_default, $this->_options['cookie']);
            } else {
     ...
     * @access public
     */
    public function setRememberCookie($handle, $passwd) : bool
    {
     ...
     * @access public
     */
    public function readRememberCookie()
    {
        if (!array_key_exists('cookie', $this->_options)
     ...
     * @access public
     */
    public function logout($direct = true) : bool
    {
     ...
     * @access public
     */
    public function checkRight($rights) : ?int
    {
        if (is_null($rights)) {
     ...
     * @access public
     */
    public function getProperty($what, $container = 'auth')
    {
        $that = null;
